...
async function createEfadaDOCX({ nationalId, date, picturePath, student, sd,name }) {
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            ...
            children: [
              run("السيد الأستاذ الدكتور/", { bold: true, size: SIZE_ADDR }),
            ],
          }),
                  ...
                  new TableCell({
                    ...
                    children: [
                      new Paragraph({
                        ...
                        spacing: { before: 200 },
                        children: [run(`المستخرج: ${name}`, { bold: true })],
                      }),
                    ],
                  }),
